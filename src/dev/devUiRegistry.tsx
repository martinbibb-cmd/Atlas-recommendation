...
export const DEV_UI_REGISTRY: DevUiRegistryItem[] = [
  ...
  },
  {
    ...
    category: 'audit',
    status: 'active',
    notes: 'Dev-only library browser for concepts, journeys, diagrams, animations, lived-experience cards, print fallbacks, and projection status.',
    routeKind: 'path',
  ...
  },
  {
    ...
    category: 'audit',
    status: 'active',
    notes: 'PR 1 QA fixture — canonical physical primitive library. Shows every extracted primitive at mobile/print/no-label/print-safe widths. Homeowner recognisability acceptance test.',
    routeKind: 'path',
  ...
  },
  {
    ...
    category: 'audit',
    status: 'active',
    notes: 'PR 2 QA fixture — canonical physical topology diagrams composed from PR 1 primitives only.',
    routeKind: 'path',
  ...
  },
  {
    ...
    category: 'audit',
    status: 'active',
    notes: 'PR 3 QA fixture — canonical topology with anchored analogy overlays and mode switching.',
    routeKind: 'path',
