/**
 * QuotePlannerProgress.tsx
 *
 * Blue-pill stepper progress bar for the Quote Planner.
 *
 * Renders:
...
export interface QuotePlannerProgressProps {
...
export function QuotePlannerProgress({
  steps,
  currentStep,
}: QuotePlannerProgressProps) {
    ...
    <div className="qp-progress">
      <div className="qp-progress__bar-track">
        <div
          ...
          aria-valuemin={0}
          aria-valuemax={100}
          aria-label="Quote planner progress"
        />
      </div>
