/**
 * installationSpecificationSelectors.ts
 *
 * Pure data-selection helpers for `QuoteInstallationPlanV1` (Installation Specification).
 *
 ...
 */
export function hasInstallationSpecificationMinimumLocations(
  plan: QuoteInstallationPlanV1,
): boolean {
