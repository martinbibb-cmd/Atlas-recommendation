/**
 * buildInstallationSpecificationDraft.ts
 *
 * Builds an initial `QuoteInstallationPlanV1` draft from the current survey
 * state, Atlas recommendation, and optional scan evidence (Installation Specification).
 *
 * Design rules:
 ...
 */
export interface BuildInstallationSpecificationDraftInput {
  /**
...
// ─── buildInstallationSpecificationDraft ────────────────────────────────────
 ...
 */
export function buildInstallationSpecificationDraft(
  input: BuildInstallationSpecificationDraftInput = {},
): QuoteInstallationPlanV1 {
  const {
    visitId,
    planId,
