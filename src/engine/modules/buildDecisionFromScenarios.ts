...
function buildCompatibilityWarnings(scenario: ScenarioResult): string[] {
  ...
  if (flags.pressureConstraint) {
    warnings.push('During high simultaneous demand, shower intensity may reduce slightly — stored hot water handles simultaneous demand more effectively than on-demand heating');
  }
