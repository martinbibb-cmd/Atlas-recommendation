...
const REGISTRY: PhysicsVisualDefinition[] = [
  ...
  {
    id: 'cylinder_charge_standard',
    title: 'Standard cylinder — charge and discharge',
    concept: 'A standard hot water cylinder warms through its full body as it charges.',
    purpose:
      'Shows a standard (open-vented or unvented) cylinder charging progressively — the whole stored volume warms gradually, with the top warming first. Discharge depletes the usable volume overall.',
    defaultDurationMs: 3500,
    supportsReducedMotion: true,
    supportsInteraction: true,
    category: 'water',
  ...
  {
    id: 'cylinder_charge_mixergy',
    title: 'Mixergy cylinder — stratified charge',
    concept: 'A Mixergy cylinder concentrates heat at the top, so usable hot water is ready immediately even when partially charged.',
    purpose:
      'Shows a Mixergy stratified cylinder charging from the top down — the hot/warm boundary descends as charge increases, giving maximum usable volume from a partial charge. Discharge shrinks the top hot layer visibly.',
    defaultDurationMs: 3500,
    supportsReducedMotion: true,
    supportsInteraction: true,
    category: 'water',
