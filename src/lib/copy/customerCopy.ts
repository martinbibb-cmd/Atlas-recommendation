...
export const PORTAL_FOOTER_COPY =
  'This recommendation is based on a physics-based heating system assessment. ' +
  'For questions about your recommendation, contact ' +
...
/** Heading for the "Why this works well" mini-summary. */
export const WHY_ATLAS_HEADING = 'Why this works well';
